//Archiver
//(C)2001 George Birbilis - Agrinio Club
//Version: 11Oct2001
...
begin
 ...
 try
  ...
  on e:Exception do feedback.ShowError('Uploading failed: '+e.message);
 end;
end;
...
begin
 ...
 remote.Logout;
  ...
  on e:Exception do feedback.ShowError('Failed at logout: '+e.message);
 end;
end;
